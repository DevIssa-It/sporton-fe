        ...
        <CardWithHeader title="Order Information">
            <div className="p-5">
                ...
                <div className="input-group">
                    ...
                    <input type="text" placeholder="+62xxxx" id="customerContact" name="customerContact" value={formData.customerContact ?? ""} onChange={handleInputChange} />
                </div>
                <div className="input-group">
                    <label htmlFor="shipping_address">Shipping Address</label>
                    <textarea placeholder="Example Street, 18, West Jakarta, Indonesia, 66521" id="shipping_address" name="customerAddress" value={formData.customerAddress} onChange={handleInputChange} rows={8} />
                </div>
            </div>
        </CardWithHeader>
    )
