                    ...
                    <div className="bg-white rounded-lg border border-gray-200" key={index}>
                        <div className="flex justify-between p-5">
                            ...
                            <div className="flex gap-2 -mt-5 text-gray-600">
                                <button type="button" title="Edit BankInfo" className="cursor-pointer"><FiEdit2 size={20} /></button>
                                <button type="button" title="Delete BankInfo" className="cursor-pointer"><FiTrash2 size={20} /></button>
                            </div>
                        </div>
