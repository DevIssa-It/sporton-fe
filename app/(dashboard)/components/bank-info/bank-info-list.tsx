                    ...
                    <div className="bg-white rounded-lg border border-gray-200" key={data._id}>
                        <div className="flex justify-between p-5">
                            ...
                            <div className="flex gap-2 -mt-5 text-gray-600">
                                <button type="button" title="Edit BankInfo" className="cursor-pointer"><FiEdit2 size={20} onClick={() => onEdit(data)} /></button>
                                <button type="button" title="Delete BankInfo" className="cursor-pointer"><FiTrash2 size={20} onClick={() => onDelete(data._id)} /></button>
                            </div>
                        </div>
                        <div className="p-5 font-medium">
                            <div className="text-xs opacity-50">ACCOUNT NUMBER</div>
                            <div className="font-semibold">{data.accountNumber}</div>
                        </div>
