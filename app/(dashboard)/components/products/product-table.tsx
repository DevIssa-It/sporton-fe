                ...
                <tbody>
                    {products.map((data, index) => (
                        <tr key={data._id} className="border-b border-gray-200 last:border-b-0">
                            ...
                            <td className="px-6 py-4 font-medium">
                                <div className="rounded-md bg-gray-200 px-3 py-1 w-fit">{data.category.name}</div>
                            </td>
                            ...
                            <td>
                                <div className="px-7 py-4 flex self-center items-center gap-3 text-gray-600">
                                    <button type="button" title="Edit product" onClick={() => onEdit?.(data)} className="cursor-pointer"><FiEdit2 size={20} /></button>
                                    <button type="button" title="Delete product" onClick={() => onDelete?.(data._id)} className="cursor-pointer"><FiTrash2 size={20} /></button>
                                </div>
                            </td>
                        </tr>
                    ))}
